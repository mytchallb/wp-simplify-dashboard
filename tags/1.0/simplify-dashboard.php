...
function simplify_dashboard_enqueue_scripts($hook)
{
  if (is_admin()) {
    wp_enqueue_script('simplify-dashboard-script', plugin_dir_url(__FILE__) . 'simplify-dashboard.js', array('jquery'), '1.3', true);
    wp_enqueue_style('simplify-dashboard-style', plugin_dir_url(__FILE__) . 'simplify-dashboard.css');
  }
}
